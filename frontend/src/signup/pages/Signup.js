        ...
        >
          {({ errors, touched, setFieldValue }) => (
            ...
            <Form className="signup-form">
              <h1 className="signup-title" data-testid="header">
                Sign up
              </h1>
              <TextInput
                name="email"
              ...
              <Select name="city" label="City" data-testid="city">
                <option value="" data-testid="select_city">
                  Select A City
                </option>
                <option value="Winnipeg" data-testid="winnipeg">
                  Winnipeg
                </option>
                <option value="Toronto" data-testid="toronto">
                  Toronto
                </option>
              </Select>
              <TextInput
              ...
              {touched.image && errors.image ? (
                <div className="signup-errorMessage">{errors.image}</div>
              ) : null}
              <div
